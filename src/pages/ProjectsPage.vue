      ...
      projects: [
        {
          ...
          image: "Fantopy.png",
          description: "A movies website using TMDB API where movies are categorized, and trailers can be viewed.",
          showButton: true,
        },
        {
          ...
          image: "Suisse.png",
          description: "An interactive React app for organizing meetups. Uses Firebase for storing meetups and favorites.",
          showButton: true,
        },
        {
          title: "Data Warehouse Storage",
          image: "Tentastique.png",
          description: "Complete warehouse storage system for managing products, their attributes, deals, offers, invoices and everything you need. The platform also handles meeting scheduling and streamlines business operations",
          showButton: false,
        },
        {
          ...
          description: "The biggest project I have worked on is a Departmentware Store for Police Stations and Officers in the USA, where we...",
          showButton: true,
        },
